...
const ageDisplayBlock = require('../generated_pages/variants_content/age-display-block.page.js');
const summaryPage = require('../generated_pages/variants_content/summary.page.js');
